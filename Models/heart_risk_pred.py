...
Original file is located at
    https://colab.research.google.com/drive/1HmJ2u0034kiPX34vjbp4dn1a7wLZvBf_
"""
...
data_df=pd.read_csv('/content/grive/MyDrive/Dataset for ML and DL/Capstone/hypertension_data.csv')
data_df.head(5)
...
train =pd.read_csv('/content/grive/MyDrive/Dataset for ML and DL/heart.csv')
train.head(5)
...
Most of the patients has no high levels of fastin blood sugar.
